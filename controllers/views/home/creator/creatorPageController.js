...
module.exports = async (req, res) => {
  ...
  await Member.check(id_creator, id_user).then(async (result) => {
    ...
    res.render('home/creator/index', { title_nav: `${creator[0].creator_name} | Octagram`, creators: creator, checks: result, posts: post });
    ...
    console.log(error)
    res.locals.layout = 'home/components/layout';
    res.render('home/creator/index', { title_nav: `${creator[0].creator_name} | Octagram`, creators: creator, checks: error, packages: package, posts: post });
