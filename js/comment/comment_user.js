                ...
                <div class="tooltip_comment">
                    ...
                    <div class="tooltip_comment_bar">
                        <div class="tooltip-content">
                            ...
                            <a href="/post/comment/delete?id_comment=${comment.id}&callback=home&role=USER" class="tooltip-option" id="comment_remove"><i class="fa-solid fa-trash tooltip_icon"></i>ลบ</a>
                        </div>
                    </div>
                </div>
            </div>
